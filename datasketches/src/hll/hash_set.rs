...
impl HashSet {
    ...
    pub fn update(&mut self, coupon: Coupon) {
        ...
        loop {
            ...
            let stride = ((coupon.0 & KEY_MASK_26) >> self.container.lg_size()) | 1;
